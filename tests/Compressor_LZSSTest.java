...
public class Compressor_LZSSTest {
    ...
    public static void mainTests() throws IOException {
        ...
        String[] files = {
                "../src/persistencia/testing_files/txt/sample1",
                "../src/persistencia/testing_files/txt/500kb",
                "../src/persistencia/testing_files/txt/200kb",
                "../src/persistencia/testing_files/txt/sample2",
                "../src/persistencia/testing_files/txt/sample3"
        };
